...
class AnketaForm(forms.Form):
    ...
    internet = forms.ChoiceField(label='Вы пользуесь интернетом',choices=[('1','Каждый день'),
    ...
    message = forms.CharField(label='Ваше обращение', widget=forms.Textarea(attrs={'rows':12,'cols':20}))
